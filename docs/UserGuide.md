...
| `TAG` | A tag describing additional information about the athlete                 | **OPTIONAL**, but if provided, can contain letters, numbers, hyphens (-), slashes (/), plus (+), underscores (_), parentheses (), apostrophes ('). No spaces. Up to 100 characters long.                                                                                                                                              |
...
| `TEAM_NAME` | A team's name in the address book                                         | Must not be blank (only whitespaces). Can contain letters, numbers, spaces, hyphens (-), apostrophes ('), periods (.), parentheses ( ). Must be 1–80 characters long.                                                                                                                                                                 |
